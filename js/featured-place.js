...
import { safeImageURL } from "./ui.js?v=45";
import { tripDayNumberForDate, tripRouteStops } from "./trip-model.js?v=45";
import { searchNearbyPlaces, searchPlaceDetails } from "../maps.js?v=45";
