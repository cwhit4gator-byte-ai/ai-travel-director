...
import { safeImageURL } from "./ui.js?v=42";
import { tripDayNumberForDate, tripRouteStops } from "./trip-model.js?v=42";
import { searchNearbyPlaces, searchPlaceDetails } from "../maps.js?v=42";
