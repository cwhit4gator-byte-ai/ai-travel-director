...
import { escapeHTML } from "./ui.js?v=28";
import { trackAppEvent } from "../firebase-client.js?v=28";
import { tripDateForDay, formatTripDate, tripDayNumberForDate, tripOvernightStops } from "./trip-model.js?v=28";
import { nextIncompleteTripStop, currentLocationDirectionsURL } from "./directions.js?v=28";
