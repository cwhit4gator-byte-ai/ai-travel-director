...
import { focusGooglePlaceResult, renderGoogleMap, renderGooglePlaceResultsMap, renderGoogleRouteMap, searchNearbyPlaces } from "../maps.js?v=48";
import { currentDestination, tripRouteStops } from "./trip-model.js?v=48";
