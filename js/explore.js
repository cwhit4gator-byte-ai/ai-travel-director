...
import { focusGooglePlaceResult, renderGoogleMap, renderGooglePlaceResultsMap, renderGoogleRouteMap, searchNearbyPlaces } from "../maps.js?v=49";
import { currentDestination, tripRouteStops } from "./trip-model.js?v=49";
