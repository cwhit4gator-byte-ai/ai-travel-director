...
import { normalizeInterests, trackAppError } from "./ui.js?v=47";
import { scheduleSave } from "./persistence.js?v=47";
import { requestAITrip, trackAppEvent } from "../firebase-client.js?v=47";
import { normalizeAITrip, buildLocalTrip, tripForAIContext, preserveActiveTripDetails } from "./trip-model.js?v=47";
import { communityItems } from "./community-data.js?v=47";
