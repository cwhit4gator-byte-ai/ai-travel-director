...
import { normalizeInterests, trackAppError } from "./ui.js?v=46";
import { scheduleSave } from "./persistence.js?v=46";
import { requestAITrip, trackAppEvent } from "../firebase-client.js?v=46";
import { normalizeAITrip, buildLocalTrip, tripForAIContext, preserveActiveTripDetails } from "./trip-model.js?v=46";
import { communityItems } from "./community-data.js?v=46";
